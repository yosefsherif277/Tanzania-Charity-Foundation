...
export default function ContactContent({ lng }: { lng: Locale }) {
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="rounded-xl overflow-hidden h-96">
              <iframe
                title="Tanga Tanzania Location"
                className="w-full h-full"
                src="https://maps.google.com/maps?q=W3CQ+XHM%20Tanga%20Tanzania&output=embed"
                allowFullScreen
                loading="lazy"
