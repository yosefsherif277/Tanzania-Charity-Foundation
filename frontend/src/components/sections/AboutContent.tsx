...
export default function AboutContent({ lng }: { lng: Locale }) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="card card-hover">
              ...
              <h3 className="font-display text-2xl font-bold text-charcoal mb-4">
                <AnimatedText text={t("ourPurpose.mission")} delay={0.4} />
              </h3>
              <div className="text-charcoal/70 leading-relaxed">
                <AnimatedText text={t("ourPurpose.missionText")} delay={0.6} />
              </div>
            </div>
            ...
            <div className="card card-hover">
              ...
              <h3 className="font-display text-2xl font-bold text-charcoal mb-4">
                <AnimatedText text={t("ourPurpose.vision")} delay={0.4} />
              </h3>
              <div className="text-charcoal/70 leading-relaxed">
                <AnimatedText text={t("ourPurpose.visionText")} delay={0.6} />
              </div>
            </div>
          </div>
        </div>
